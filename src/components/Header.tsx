      ...
      <Image 
        ...
        {/* Title Section with Logo - Centered */}
          ...
          <View className="flex-1 items-center">
            <Text className="text-2xl font-bold text-gray-800 dark:text-gray-200">CC Tool</Text>
            {subtitle && <Text className="text-md text-gray-600 dark:text-gray-400">{title}</Text>}
          </View>
        ...
        <View className="w-12 h-12 items-center justify-center">
          {rightAction ? (
            <TouchableOpacity
              ...
              <Ionicons name={rightAction.icon as any} size={24} color={colorScheme === 'dark' ? '#D1D5DB' : '#374151'} />
            </TouchableOpacity>
          ) : (
